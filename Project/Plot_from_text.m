...
fileName_color_seg_true = 'loss_color_seg.txt';
fileName_color_seg = 'loss_color_seg_full.txt';
...
title_of_plot_color_seg_true = "Autoencoder using true segmentation loss";
...
[batch_vector_color_seg_true, train_loss_color_seg_true, val_loss_color_seg_true] = txt_to_data(fileName_color_seg_true, print_every);
...
figure
hold on; grid on; box on
title(title_of_plot_color_seg_true)
xlabel("Batches")
ylabel("MSE Loss")
set(gcf,'color','w');
plot(batch_vector_color_seg_true, val_loss_color_seg_true,'LineWidth',1.5)
plot(batch_vector_color_seg_true, train_loss_color_seg_true,'LineWidth',1.5)
legend("Validation loss", "Train loss")
saveas(gcf, title_of_plot_color_seg_true, 'epsc')
